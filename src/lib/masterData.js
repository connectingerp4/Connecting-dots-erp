...
export const coursesData = {
  ...
  "sap-fico": {
    ...
    header: {
      ...
      description:
        "Enroll in the best SAP FICO course in {city} and master financial accounting and controlling with expert-led training. Our SAP FICO training in {city} offers real-time Training, industry-relevant curriculum, and 100% placement support to help you build a successful career in SAP finance modules.",
      backgroundVideo: "/backgroundvideo/sap.mp4",
      features: ["Live Class", "1:1 mentorship", "Industry projects"],
      alumni: [
        // Used in: Header carousel/logos
        { name: "Amdocs", logo: "/courseheader/amdocs.avif" },
        { name: "Infosys", logo: "/courseheader/infosys.avif" },
        { name: "Cognizant", logo: "/courseheader/cognizant.avif" },
        { name: "TCS", logo: "/courseheader/tcs.avif" },
        { name: "IBM", logo: "/courseheader/IBM.avif" },
      ],
      buttons: [
  ...
  it: {
    ...
    header: {
      ...
      backgroundVideo: "/backgroundvideo/it courses.mp4",
      features: ["Live Class", "1:1 mentorship", "Industry projects"],
      alumni: [
        // Used in: Header carousel/logos
        { name: "Amdocs", logo: "/courseheader/amdocs.avif" },
  ...
  "data-visualization": {
    ...
    header: {
      ...
      backgroundVideo: "/backgroundvideo/datavisualization.mp4",
      features: ["Live Class", "1:1 mentorship", "Industry projects"],
      alumni: [
        // Used in: Header carousel/logos
        { name: "Amdocs", logo: "/courseheader/amdocs.avif" },
  ...
  "digital-marketing": {
    ...
    header: {
      ...
      backgroundVideo: "/backgroundvideo/digital.webm",
      features: ["Live Class", "1:1 mentorship", "Industry projects"],
      alumni: [
       // Used in: Header carousel/logos
        { name: "Amdocs", logo: "/courseheader/amdocs.avif" },
  ...
  "hr-training": {
    ...
    header: {
      ...
      backgroundVideo: "/backgroundvideo/hr.mp4",
      features: ["Live Class", "1:1 mentorship", "Industry projects"],
      alumni: [
        // Used in: Header carousel/logos
        { name: "Amdocs", logo: "/courseheader/amdocs.avif" },
